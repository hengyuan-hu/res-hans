...
from misc import get_session, save_model
...
def main():
    ...
    model_2, _ = resnet_cifar10.resnet_cifar10(repetations=3)
    # model_2 = model_mnist()
    ...
    # Evaluate the accuracy of the adversarially trained model on
